...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='elgoog/api/http.proto',
  package='elgoog.api',
  syntax='proto3',
  serialized_pb=_b('\n\x15\x65lgoog/api/http.proto\x12\nelgoog.api\"+\n\x04Http\x12#\n\x05rules\x18\x01 \x03(\x0b\x32\x14.elgoog.api.HttpRule\"\xea\x01\n\x08HttpRule\x12\x10\n\x08selector\x18\x01 \x01(\t\x12\r\n\x03get\x18\x02 \x01(\tH\x00\x12\r\n\x03put\x18\x03 \x01(\tH\x00\x12\x0e\n\x04post\x18\x04 \x01(\tH\x00\x12\x10\n\x06\x64\x65lete\x18\x05 \x01(\tH\x00\x12\x0f\n\x05patch\x18\x06 \x01(\tH\x00\x12/\n\x06\x63ustom\x18\x08 \x01(\x0b\x32\x1d.elgoog.api.CustomHttpPatternH\x00\x12\x0c\n\x04\x62ody\x18\x07 \x01(\t\x12\x31\n\x13\x61\x64\x64itional_bindings\x18\x0b \x03(\x0b\x32\x14.elgoog.api.HttpRuleB\t\n\x07pattern\"/\n\x11\x43ustomHttpPattern\x12\x0c\n\x04kind\x18\x01 \x01(\t\x12\x0c\n\x04path\x18\x02 \x01(\tB\'\n\x0e\x63om.elgoog.apiB\tHttpProtoP\x01\xf8\x01\x01\xa2\x02\x04GAPIb\x06proto3')
)
...
_HTTP = _descriptor.Descriptor(
  name='Http',
  full_name='elgoog.api.Http',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rules', full_name='elgoog.api.Http.rules', index=0,
...
_HTTPRULE = _descriptor.Descriptor(
  name='HttpRule',
  full_name='elgoog.api.HttpRule',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='selector', full_name='elgoog.api.HttpRule.selector', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get', full_name='elgoog.api.HttpRule.get', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='put', full_name='elgoog.api.HttpRule.put', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='post', full_name='elgoog.api.HttpRule.post', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='delete', full_name='elgoog.api.HttpRule.delete', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='patch', full_name='elgoog.api.HttpRule.patch', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='custom', full_name='elgoog.api.HttpRule.custom', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='body', full_name='elgoog.api.HttpRule.body', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='additional_bindings', full_name='elgoog.api.HttpRule.additional_bindings', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='pattern', full_name='elgoog.api.HttpRule.pattern',
...
_CUSTOMHTTPPATTERN = _descriptor.Descriptor(
  ...
  full_name='elgoog.api.CustomHttpPattern',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='kind', full_name='elgoog.api.CustomHttpPattern.kind', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='path', full_name='elgoog.api.CustomHttpPattern.path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Http = _reflection.GeneratedProtocolMessageType('Http', (_message.Message,), dict(
  DESCRIPTOR = _HTTP,
  __module__ = 'elgoog.api.http_pb2'
  # @@protoc_insertion_point(class_scope:elgoog.api.Http)
  ))
...
HttpRule = _reflection.GeneratedProtocolMessageType('HttpRule', (_message.Message,), dict(
  ...
  __module__ = 'elgoog.api.http_pb2'
  # @@protoc_insertion_point(class_scope:elgoog.api.HttpRule)
  ))
...
CustomHttpPattern = _reflection.GeneratedProtocolMessageType('CustomHttpPattern', (_message.Message,), dict(
  ...
  __module__ = 'elgoog.api.http_pb2'
  # @@protoc_insertion_point(class_scope:elgoog.api.CustomHttpPattern)
  ))
_sym_db.RegisterMessage(CustomHttpPattern)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\016com.elgoog.apiB\tHttpProtoP\001\370\001\001\242\002\004GAPI'))
